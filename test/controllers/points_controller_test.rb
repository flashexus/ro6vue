...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { deleted_at: @point.deleted_at, desc: @point.desc, lat: @point.lat, lon: @point.lon, name: @point.name, path: @point.path } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { deleted_at: @point.deleted_at, desc: @point.desc, lat: @point.lat, lon: @point.lon, name: @point.name, path: @point.path } }
